 ...
 * @Last modified time: 2018-01-27T16:45:34+08:00
 */
...
#   if __GNUC__ < 2 || (__GNUC__ == 2 && __GNUC_MINOR__ < 8)
 ...
 #   define __STL_SIMPLE_USE_NAMESPACE_FOR_RELOPS
 #   define __STL_SIMPLE_BEGIN_RELOPS_NAMESPACE namespace simple_stl {
 #   define __STL_SIMPLE_END_RELOPS_NAMESPACE }
 #   define __STD_SIMPLE_RELOPS simple_stl
 # else
 #   define __STD_SIMPLE
 #   define __STL_SIMPLE_BEGIN_NAMESPACE
 #   define __STL_SIMPLE_END_NAMESPACE
 #   undef  __STL_SIMPLE_USE_NAMESPACE_FOR_RELOPS
 #   define __STL_SIMPLE_BEGIN_RELOPS_NAMESPACE
 #   define __STL_SIMPLE_END_RELOPS_NAMESPACE
 #   define __STD_SIMPLE_RELOPS
 # endif

 # ifdef __STL_SIMPLE_USE_EXCEPTIONS
 #   define __STL_SIMPLE_TRY try
 #   define __STL_SIMPLE_CATCH_ALL catch(...)
 #   define __STL_SIMPLE_RETHROW throw
 #   define __STL_SIMPLE_NOTHROW throw()
 #   define __STL_SIMPLE_UNWIND(action) catch(...) { action; throw; }
 # else
 #   define __STL_SIMPLE_TRY
 #   define __STL_SIMPLE_CATCH_ALL if (false)
 #   define __STL_SIMPLE_RETHROW
 #   define __STL_SIMPLE_NOTHROW
 #   define __STL_SIMPLE_UNWIND(action)
 # endif
