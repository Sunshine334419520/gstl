 ...
 * @Last modified time: 2018-03-19T14:11:16+08:00
 */
#include "MultiMap.h"
#include <iostream>
#include <string>
...
int main(int argc, char const *argv[]) {
  gstl::MultiMap<string, int> simap;
  //simap[string("C")] = 1;
  //simap[string("C++")] = 2;
  //simap[string("Java")] = 3;
  //simap[string("Python")] = 4;
  simap.insert(gstl::make_pair(string("C"), 1));
  simap.insert(gstl::make_pair(string("C++"), 2));
  simap.insert(gstl::make_pair(string("Java"), 3));
  simap.insert(gstl::make_pair(string("Python"), 4));
  simap.insert(gstl::make_pair(string("Python"), 5));
  ...
  simap.insert(gstl::make_pair(string("JavaScript"), 9));

  gstl::MultiMap<string, int>::iterator it1 = simap.begin();
  gstl::MultiMap<string, int>::iterator it2 = simap.end();
